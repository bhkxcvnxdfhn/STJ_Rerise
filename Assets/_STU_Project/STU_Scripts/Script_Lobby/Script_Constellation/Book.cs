...
public class Book : MonoBehaviour {
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        {
            Right.sprite = endCap;
            RightNext.color = RightNext.color.GetAlphaColor(0);
        }
        else
        {
            Right.sprite = bookPages[currentPage];
            RightNext.sprite = bookPages[currentPage + 1];
        }
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        if (currentPage == 2)
        {
            LeftNext.color = LeftNext.color.GetAlphaColor(0);
            Left.sprite = cover;
        }
        else
        {
            Left.sprite = bookPages[currentPage - 3];
            LeftNext.sprite = bookPages[currentPage - 4];
        }
    ...
    void UpdateSprites()
    {
        ...
        {
            LeftNext.color = LeftNext.color.GetAlphaColor(0);
            RightNext.sprite = cover;
        }
        else if(currentPage <= bookPages.Length)
        {
            LeftNext.color = LeftNext.color.GetAlphaColor(1);
            LeftNext.sprite = bookPages[currentPage - 2];
        }

        if (currentPage > bookPages.Length) //尾
        {
            RightNext.color = RightNext.color.GetAlphaColor(0);
            LeftNext.sprite = endCap;
        }
        else if(currentPage > 0)
        {
            RightNext.color = RightNext.color.GetAlphaColor(1);
            RightNext.sprite = bookPages[currentPage - 1];
        }
    }
